...
const { fetchProductData, deleteProductById, checkName, checkSKU, fetchSizeStockCost, updateProduct, addProduct } = require('../controllers/productController');
...
router.get('/products/:id', fetchProductData); //exported
